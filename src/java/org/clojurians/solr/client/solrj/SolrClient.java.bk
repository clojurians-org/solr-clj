 ...
 */
package org.clojurians.solr.client.solrj;

import org.clojurians.solr.client.solrj.SolrRequest.METHOD;
import org.clojurians.solr.client.solrj.beans.DocumentObjectBinder;
import org.clojurians.solr.client.solrj.impl.StreamingBinaryResponseParser;
import org.clojurians.solr.client.solrj.request.QueryRequest;
import org.clojurians.solr.client.solrj.request.SolrPing;
import org.clojurians.solr.client.solrj.request.UpdateRequest;
import org.clojurians.solr.client.solrj.response.QueryResponse;
import org.clojurians.solr.client.solrj.response.SolrPingResponse;
import org.clojurians.solr.client.solrj.response.UpdateResponse;
import org.clojurians.solr.common.SolrDocument;
import org.clojurians.solr.common.SolrDocumentList;
import org.clojurians.solr.common.SolrInputDocument;
import org.clojurians.solr.common.StringUtils;
import org.clojurians.solr.common.params.CommonParams;
...
public abstract class SolrClient implements Serializable, Closeable {
   ...
   *
   * @return an {@link org.clojurians.solr.client.solrj.response.UpdateResponse} from the server
   *
   ...
   * {@link org.clojurians.solr.client.solrj.beans.DocumentObjectBinder}
   *
   ...
   *
   * @return an {@link org.clojurians.solr.client.solrj.response.UpdateResponse} containing the response
   *         from the server
   *
   ...
   *
   * @return a {@link org.clojurians.solr.client.solrj.response.SolrPingResponse} containing the response
   *         from the server
   *
   * @throws IOException If there is a low-level I/O error.
   * @throws SolrServerException if there is an error on the server
   ...
   *
   * @return a {@link org.clojurians.solr.client.solrj.response.QueryResponse} containing the response
   *         from the server
   *
   * @throws IOException If there is a low-level I/O error.
   * @throws SolrServerException if there is an error on the server
  ...
  /**
   * Get the {@link org.clojurians.solr.client.solrj.beans.DocumentObjectBinder} for this client.
   *
