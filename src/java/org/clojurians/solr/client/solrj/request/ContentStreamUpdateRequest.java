...
import org.clojurians.solr.common.util.ContentStreamBase;
...
/**
 * Basic functionality to upload a File or {@link org.clojurians.solr.common.util.ContentStream} to a Solr Cell or some
...
public class ContentStreamUpdateRequest extends AbstractUpdateRequest {
  ...
  /**
   *
   * @param url The URL to send the {@link org.clojurians.solr.common.util.ContentStream} to in Solr.
   */
  ...
  /**
   * Add a File to the {@link org.clojurians.solr.common.util.ContentStream}s.
   * @param file The File to add.
   * @throws IOException if there was an error with the file.
   *
   * @see #getContentStreams()
   * @see org.clojurians.solr.common.util.ContentStreamBase.FileStream
   */
  ...
  /**
   * Add a {@link org.clojurians.solr.common.util.ContentStream} to {@link #getContentStreams()}
   * @param contentStream The {@link org.clojurians.solr.common.util.ContentStream}
   */
