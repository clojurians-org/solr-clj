...
import org.clojurians.solr.client.solrj.response.DocumentAnalysisResponse;
import org.clojurians.solr.client.solrj.util.ClientUtils;
import org.clojurians.solr.common.SolrInputDocument;
import org.clojurians.solr.common.params.AnalysisParams;
...
/**
 * A request for the org.clojurians.solr.handler.DocumentAnalysisRequestHandler.
 *
 *
 * @since solr 1.4
 */
public class DocumentAnalysisRequest extends SolrRequest<DocumentAnalysisResponse> {
   ...
   * @return This DocumentAnalysisRequest (fluent interface support).
   *
   * @see #addDocument(org.clojurians.solr.common.SolrInputDocument)
   */
