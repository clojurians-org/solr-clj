...
import org.clojurians.solr.common.params.FacetParams;
import org.clojurians.solr.common.params.HighlightParams;
import org.clojurians.solr.common.params.ModifiableSolrParams;
import org.clojurians.solr.common.params.StatsParams;
import org.clojurians.solr.common.params.TermsParams;
import org.clojurians.solr.common.util.DateUtil;
...
{  
  public static final String DOCID = "_docid_"; // duplicate of org.clojurians.solr.search.SortSpecParsing.DOCID which is not accessible from here
   ...
   * {@link org.clojurians.solr.client.solrj.request.QueryRequest#getPath()} in the URL instead of the "qt" parameter.
  ...
  /**
   * @return this
   * @see org.clojurians.solr.common.params.ModifiableSolrParams#set(String, boolean)
   */
