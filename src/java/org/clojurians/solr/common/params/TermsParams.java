 ...
 */
package org.clojurians.solr.common.params;
...
public interface TermsParams {
  ...
  /**
   * Optional.  The number of results to return.  If not specified, looks for {@link org.clojurians.solr.common.params.CommonParams#ROWS}.  If that's not specified, uses {@link org.clojurians.solr.common.params.CommonParams#ROWS_DEFAULT}.
   */
